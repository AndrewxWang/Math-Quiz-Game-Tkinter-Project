...
def buttonPressed():
    ...
    if rand[choice] == answ:
        score+=1
        canvas.create_text(150,100, text="Correct! Score: " + str(score) + "/10")
    else:
        canvas.create_text(150,100,text="Wrong! " + str(score) + "/10")
...
def createGame():
    ...
    if questions <= 10:
        ...
        Score_label = Label(root,font="Arial 10 bold",text="Quiz complete! Final Score: " + str(score) + "/10")
